...
//    document.getElementById('generated-xml').innerText = newXml;
  ...
  useEffect(() =>
   //human_detection
     PubSub.subscribe('jetbot_msg/position').subscribe({
     next: data => {
       try{
  ...
  function Challenge(){
    ...
    if ((sensor.longitude>=4.0 && sensor.longitude<=5.0)
      && (sensor.latitude>=-4.3 && sensor.latitude<=-4.0)){ //change condition
      return (
        <div>
