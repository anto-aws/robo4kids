# Forked version of aws-iot-device-sdk-js
This version is published publically under `aws-iot-device-sdk-browser`
It removes a lot of the dependencies that are in Node, and thus remove
communication types that are not supported by browsers.

The intent of this fork is to provide a _minimal_ implementation of
aws-iot-device-sdk that can be bundled in client side code. This also
helps fix some issues when attempting to rollup this repo.

This has no intention of ever being merged upstream.
